...
<marquee bahavior="scroll">Search Book By Book Name</marquee>
<div id="div3">
...
of a particular book.Please put the <span style="color:red">Book Name</span> and search and get the result.
</p>
</div>
<form id="theForm9" action="" method="POST">
<div class="row">
<label for="bookName">Book Name</label>
<input type="text" id="bookName" name="bookName">
</div>
<div class="row">
<input type="Submit" value="Search" name="search3" onclick="return validationForm9()"/>
</div>
</form>
Avaliable Books are:
<table border = 2>
...
if(isset($_POST['search3'])){
 ...
 $query = "SELECT * FROM table1 WHERE BOOKNAME = '$bookName'";
 ...
 if($row = mysqli_fetch_array($query_run))
 {
	 ...
	 echo"<font color='red'><i>The Library Not Has Any Book With This Name</i></font>";
 }
}
?>
</table>
...
function validationForm9()
{
	var box1=document.getElementById("bookName");
	if(box1.value=="" )
	{
		alert("Please Fill the Book Name  Fields");
		if(box1.value=="")
		{
		box1.focus();
